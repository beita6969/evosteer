...
OUT=/workspace/evosteer_runs/9b_paper_v10b_${STAMP}
...
echo "$OUT" > /workspace/evosteer_runs/active_9b_paper_v10b.out
exec /workspace/evosteer/venv313/bin/python -u -m skillev.evosteer_cli train \
  --config /workspace/evosteer_9b_paper_v10b_config.json \
  --task-factory skillev.experiments.curve_benchmarks:task_factory \
  --resume /workspace/evosteer_runs/9b_paper_v10_20260920-061146/checkpoints/batch-000040 \
  --output "$OUT"
