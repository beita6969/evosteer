...
OUT=/workspace/evosteer_runs/9b_paper_v10d_${STAMP}
...
echo "$OUT" > /workspace/evosteer_runs/active_9b_paper_v10d.out
exec /workspace/evosteer/venv313/bin/python -u -m skillev.evosteer_cli train \
  --config /workspace/evosteer_9b_paper_v10d_config.json \
