...
pilot = json.load(open("/workspace/evosteer/pilot_9b.json"))
...
src = "/workspace/evosteer/SKILLEV-new-main/data/paper_benchmarks/paper_benchmarks.jsonl"
dst = "/workspace/evosteer/SKILLEV-new-main/data/paper_benchmarks/paper_benchmarks_9b_mixed.jsonl"
...
json.dump({"pilot_samples": pilot["samples"], "pilot_cap": pilot["cap"], "rule": "0 < p_hat < 1",
          ...
          open("/workspace/evosteer/pool_9b_mixed.json", "w"), indent=1)
