...
OUT=/workspace/evosteer_runs/9b_paper_v11_${STAMP}
...
echo "$OUT" > /workspace/evosteer_runs/active_9b_paper_v11.out
exec /workspace/evosteer/venv313/bin/python -u -m skillev.evosteer_cli train \
  --config /workspace/evosteer_9b_paper_v11_config.json \
