"""Offline difficulty pilot: solver-only success rate of the frozen 9B executor per task.
...
CAP = int(sys.argv[3]) if len(sys.argv) > 3 else 8192
SOLVER = "Solve the public task. Give the final answer in the form the task requests."
